...
const RollingGallery: React.FC<RollingGalleryProps> = ({
  ...
  if (!isMounted) {
    return <div className="relative h-[500px] w-full overflow-hidden flex items-center justify-center">
      <div className="text-purple-200">Loading gallery...</div>
    </div>;
  }
      ...
      <div className="flex h-full items-center justify-center [perspective:1000px] [transform-style:preserve-3d]">
        ...
        >
          {galleryImages.map((url, i) => (
            <div
              key={i}
              className="group absolute flex h-fit items-center justify-center p-[4%] [backface-visibility:hidden] md:p-[4%]"
              style={{
                width: `${faceWidth}px`,
